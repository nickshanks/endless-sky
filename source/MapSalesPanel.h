...
protected:
	...
	void DrawSprite(const Point &corner, const Sprite *sprite, const Swizzle * swizzle, int frame = 0) const;
	void Draw(Point &corner, const Sprite *sprite, const Swizzle *swizzle, int frame, bool isForSale, bool isSelected,
