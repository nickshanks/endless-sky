...
protected:
	void DrawShip(const Ship &ship, const Point &center, bool isSelected, bool isOwned = false) const;
	...
	virtual void AddItemZone(const std::string &name, const Point &point) = 0;
